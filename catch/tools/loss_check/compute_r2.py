...
df_cpu=pd.read_csv(log1_location + '/epoch_'+str(epoch)+'_'+str(bench_size)+'_1.csv',header=None)
df_mlu=pd.read_csv(log2_location + '/epoch_'+str(epoch)+'_'+str(bench_size)+'_1.csv',header=None)
