...
# the assumption of this script is that pytorch, catch and vision are all placed under ${SRC_PACKAGES}
...
export CATCH_HOME=${SRC_PACKAGES}/catch
export VISION_HOME=${SRC_PACKAGES}/vision
