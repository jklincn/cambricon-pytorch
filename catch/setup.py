...
RUN_BUILD_USE_MLUOP = bool((os.getenv('USE_MLUOP') is None)
        or (os.getenv("USE_MLUOP").upper()
             not in ['OFF', '0', 'NO', 'FALSE', 'N']))
...
include_dirs += [
    ...
    os.path.join(pytorch_source_path, 'third_party', 'pybind11', 'include'),
]
...
if os.path.exists(os.path.join(cwd, '.git')):
    shutil.copyfile(base_dir + '/scripts/hooks/pre-commit',
...
setup(
    ...
    package_data={
        'torch_mlu': [
            ...
            'csrc/aten/mluop/*.h',
            'csrc/aten/*.h',
            'csrc/aten/generated/*.h',
            'csrc/aten/viewchain/*.h',
            'csrc/aten/operators/*.h',
            'csrc/aten/operators/cnnl/*.h',
            'csrc/aten/operators/cnnl/internal/*.h',
            'csrc/aten/operators/bang/*.h',
            'csrc/aten/operators/bang/internal/*.h',
            'csrc/aten/operators/mluop/*.h',
            'csrc/aten/operators/mluop/internal/*.h',
            'csrc/aten/operators/cpu/*.h',
            'csrc/aten/operators/cpu/internal/*.h',
            'csrc/aten/operators/autograd/*.h',
            'csrc/aten/utils/*.h',
            ...
            'csrc/framework/core/*.h',
            'csrc/framework/distributed/*.h',
            'csrc/framework/generator/*.h',
            'csrc/framework/hooks/*.h',
            'csrc/framework/storage/*.h',
            'csrc/python/*.h',
            'csrc/utils/*.h',
        ],
    },
