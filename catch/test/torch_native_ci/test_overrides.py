...
def generate_tensor_like_torch_implementations():
    ...
    testing_ignore = {"sample_functional", "is_mlu_available", "tensor_mlu", "__get__",
                     "get_autocast_mlu_dtype", "is_autocast_mlu_enabled", "set_autocast_mlu_dtype",
                     "set_autocast_mlu_enabled"}
