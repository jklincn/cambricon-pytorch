...
from torch.testing._internal.common_device_type import \
    (instantiate_device_type_tests, onlyNativeDeviceTypes,
...
class TestSortAndSelect(TestCase):
    ...
    def test_sort_large_slice(self, device):
        ...
        self.assertEqual(res1val, res1val_cpu.mlu())
        self.assertEqual(res1ind, res1ind_cpu.mlu())
    ...
    def test_stable_sort_against_numpy(self, device, dtype):
        ...
        def generate_samples():
            ...
            if self.device_type == 'cuda' or self.device_type == 'mlu':
                return
    ...
    @dtypesIfMLU(*all_types_and(torch.bfloat16))
    @dtypes(*all_types())
