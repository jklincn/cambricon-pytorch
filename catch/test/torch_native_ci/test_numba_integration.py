...
TEST_NUMBA_MLU = False

class TestNumbaIntegration(common.TestCase):
    @unittest.skipIf(not TEST_NUMPY, "No numpy")
    @unittest.skipIf(not TEST_MLU, "No mlu")
    def test_mlu_array_interface(self):
    ...
    @unittest.skipIf(not TEST_MLU, "No mlu")
    @unittest.skipIf(not TEST_NUMBA_MLU, "No numba.mlu")
    ...
    @unittest.skipIf(not TEST_MLU, "No mlu")
    @unittest.skipIf(not TEST_NUMBA_MLU, "No numba.mlu")
    @unittest.skipIf(not TEST_MULTIMLU, "No multimlu")
    ...
    @unittest.skipIf(not TEST_MLU, "No mlu")
    @unittest.skipIf(not TEST_NUMBA_MLU, "No numba.mlu")
    def test_from_mlu_array_interface(self):
    ...
    @unittest.skipIf(not TEST_MLU, "No mlu")
    @unittest.skipIf(not TEST_NUMBA_MLU, "No numba.mlu")
    def test_from_mlu_array_interface_inferred_strides(self):
    ...
    @unittest.skipIf(not TEST_MLU, "No mlu")
    @unittest.skipIf(not TEST_NUMBA_MLU, "No numba.mlu")
    def test_from_mlu_array_interface_lifetime(self):
    ...
    @unittest.skipIf(not TEST_NUMBA_MLU, "No numba.mlu")
    @unittest.skipIf(not TEST_MULTIMLU, "No multimlu")
    def test_from_mlu_array_interface_active_device(self):
