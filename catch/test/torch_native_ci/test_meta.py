...
from _internal.mlu_common import ops
...
meta_function_device_expected_failures['mlu'] = {
...
meta_function_device_skips['mlu'] = {
    torch.cummax: {f16},
    torch.cummin: {f16},
...
meta_dispatch_device_expected_failures['mlu'] = {
...
meta_dispatch_device_skips['mlu'] = {
...
def print_op_str_if_not_supported(op_str):
    ...
    if any(overload in d for d in [meta_dispatch_skips, meta_dispatch_device_skips['mlu']]):
        print(f"{overload}  # SKIP")
    if any(overload in d for d in [meta_dispatch_expected_failures, meta_dispatch_device_expected_failures['mlu']]):
        print(overload)
