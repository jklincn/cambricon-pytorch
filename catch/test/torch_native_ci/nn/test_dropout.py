...
from _internal.mlu_common import TEST_MLU, dtypesIfMLU
from _internal.common_nn import NNTestCase, freeze_rng_state
...
class TestDropoutNNDeviceType(NNTestCase):
    ...
    def test_Dropout1d(self, device):
        with set_default_dtype(torch.double):
            ...
            # native use torch.empty, when to('mlu'):
            # RuntimeError: datacast fail! expected smaller
            # than 3.40282e+38 and greater than -3.40282e+38but got -nan
            input = torch.zeros(N, C, L)
