...
from _internal.mlu_common import dtypes, dtypesIfMLU
...
class TestScatterGather(TestCase):
    ...
    @dtypesIfMLU(torch.float16, torch.float32)
    @dtypes(torch.float16, torch.float32, torch.complex64)
    ...
    @dtypesIfMLU(*get_all_dtypes(include_half=True, include_bfloat16=True, include_complex=False, include_bool=False))
