...
op_db: List[OpInfo] = [
    ReductionOpInfo(
        ...
        # PYTORCH-10149
        dtypesIfMLU=floating_types_and(torch.float16, torch.int8, torch.int16, torch.int32, torch.int64),
        backward_dtypesIfMLU=floating_types_and(torch.float16, torch.int8, torch.int16, torch.int32, torch.int64),
        skips=(
            DecorateInfo(
    ...
    OpInfo(
        ...
        # where op does not supoprt uint 8 on mlu
        dtypesIfMLU=floating_types_and(torch.float16, torch.int8, torch.int16, torch.int32, torch.int64),
        backward_dtypesIfMLU=floating_types_and(torch.float16, torch.int8, torch.int16, torch.int32),
        method_variant=None,
    ...
    OpInfo(
        ...
        dtypesIfCUDA=all_types_and_complex_and(torch.float16, torch.bfloat16),
        dtypesIfMLU=floating_types_and(torch.float16, torch.int8, torch.int16, torch.int32, torch.int64),
        backward_dtypesIfMLU=floating_types_and(torch.float16, torch.bool, torch.int8, torch.int16, torch.int32, torch.int64),
        method_variant=None,
        # Runs very slowly on slow gradcheck - alternatively reduce input sizes
        gradcheck_fast_mode=True,
        supports_out=False,
