...
from _internal.mlu_common import skipMLU
...
op_db: List[OpInfo] = [
    ...
    OpInfo(
        ...
        # TODO(PYTORCH-10251): mlu det use fused but native use compose.
    ...
    OpInfo(
        ...
        # TODO(PYTORCH-9646): mlu not support lu_factor now.
        decorators=[skipCPUIfNoLapack, skipCUDAIfNoMagmaAndNoCusolver, skipMLU],
        skips=(
            DecorateInfo(unittest.skip("Skipped!"),
                         'TestCommon', 'test_dtypes', device_type='mlu'),
            DecorateInfo(
