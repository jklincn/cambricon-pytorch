...
from common_utils import testinfo, TestCase, freeze_rng_state  # pylint: disable=C0413,C0411
...
class RNG(TestCase):
    ...
    def test_mlu_default_generator(self):
        ...
        self.assertTensorsEqual(g1_default_state.cpu(), g2_state.cpu(), 0.0, use_MSE=True)
