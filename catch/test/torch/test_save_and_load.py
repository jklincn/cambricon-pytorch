...
class TestSaveAndLoad(TestCase):
    ...
    def test_save_and_load(self):
        ...
        self.assertTensorsEqual(
            net_cpu.conv1.weight.cpu(), net_from_cpu.conv1.weight.cpu(), 0.0, use_MSE=True)
        self.assertTensorsEqual(
            net_mlu.conv1.weight.cpu(), net_from_mlu.conv1.weight.cpu(), 0.0, use_MSE=True)
    ...
    def test_desnet201_checkpoint_preserve_rng_state(self):
        class TestCheckPointGoogleNet(nn.Module):
            ...
            def forward(self, input):
                ...
                out = torch.utils.checkpoint.checkpoint(create_custom_forward(self.model), input)
                return out

        # use native pytorch memory strategy.
        ...
        self.assertTensorsEqual(input.grad.cpu(), checkpoint_input.grad.cpu(), 0.0, use_MSE=True)
