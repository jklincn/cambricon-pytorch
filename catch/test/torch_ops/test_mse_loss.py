...
class TestMSEOps(TestCase):
    ...
    def test_mseloss_not_dense(self):
        ...
        for shape, reduct, memory_format in product_lst:
            ...
            if reduct == "none":
                ...
                grad = torch.randn(o_shape[0], o_shape[1],
                                   o_shape[2], o_shape[3] + 1).to(memory_format = memory_format)
    ...
    def test_mseloss_dtype(self):
        ...
        for dtype , reduct in product(dtype_list, reduct_list):
            ...
            self.assertTensorsEqual(grad_input, grad_input_mlu.cpu().float(), 0.003, use_MSE=True)
