...
class Test_Masked_ScaleOp(TestCase):
    ...
    def test_masked_scale(self):
        shape_list = [(), (2, 3), (8, 224, 224), (1, 3, 16, 16),
                      (128, 128, 1, 8, 3)]
        ...
        for shape, type, scale, func in product(shape_list, type_list, scale_list, func_list):
    ...
    def test_masked_scale_broadcast(self):
        shape_list = [((2, 3), (2, 2, 3)), ((8, 22, 22), (1, 22, 22)),
                      ((1, 3, 16, 16), (1, 1, 16, 16)),
    ...
    def test_masked_scale_bfloat16(self):
        ...
        for scale in scale_list:
            cpu_input, mlu_input = TensorGenerator((1, 3, 16, 16), torch.bfloat16, lambda x:x)
            cpu_mask, mlu_mask = TensorGenerator((1, 3, 16, 16), torch.uint8, lambda x:x)
