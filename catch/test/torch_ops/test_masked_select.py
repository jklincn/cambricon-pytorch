...
class TestMaskedSelect(TestCase):
    ...
    def test_masked_select(self):
        ...
        dtype = [torch.float, torch.half, torch.long, torch.int,
                 torch.int16, torch.int8, torch.uint8, torch.bool, torch.double]
        for type_ in dtype:
            for shape in shapes:
    ...
    def test_masked_select_exception(self):
        ...
        mask_tensor = torch.tensor([True, False, True, True, False, False], device="mlu")
