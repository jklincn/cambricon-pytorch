...
class TestRNNUtilsOp(TestCase):
    ...
    def test_pack_padded_sequence(self):
        ...
        self.assertTensorsEqual(
            ...
            packed_mlu.sorted_indices.cpu(), 0.0, use_MSE=True)
        self.assertTensorsEqual(
            packed_cpu.unsorted_indices,
            packed_mlu.unsorted_indices.cpu(), 0.0, use_MSE=True)
    ...
    def test_pad_packed_sequence(self):
        ...
        seq_unpacked_cpu, lens_unpacked_cpu = pad_packed_sequence(packed_cpu, batch_first=True)
        seq_unpacked_mlu, lens_unpacked_mlu = pad_packed_sequence(packed_mlu, batch_first=True)
