...
class TestGluOp(TestCase):
    ...
    @testinfo()
    def test_glu(self):
        shape_list = [(50), (35, 46), (16, 28, 38), (128, 4, 128, 124), (14, 19, 11, 14, 22),
                  (6, 7, 8, 9, 10, 12), (16, 17, 18, 19, 20, 22)]
    ...
    def test_glu_backward_stride_channel_last(self):
        ...
        for input_shape, grad_shape, stride in zip(input_shapes, grad_shapes, strides):
            ...
            input_cpu=torch.nn.Parameter(input_t.to(memory_format=torch.channels_last))
            input_mlu=torch.nn.Parameter(input_t.to('mlu').to(memory_format=torch.channels_last))
