...
class TestRReLUOp(TestCase):
    ...
    @testinfo()
    def test_rrelu(self):
        shape_list = [(1, 6, 224), (1, 12, 24, 224), (4, 3, 224, 1024),
                      (2, 3, 12, 24, 256)]
        ...
        for shape, type, func, lower_upper in product(shape_list, type_list, func_list, lower_upper_list):
            ...
            self.assertTensorsEqual(out_cpu1, out_mlu1.cpu().float(), 0.003, use_MSE=True)
            ...
            self.assertTensorsEqual(out_cpu2, out_mlu2.cpu().float(), 0.003, use_MSE=True)
            ...
            self.assertTensorsEqual(self_cpu1, self_mlu1.cpu().float(), 0.003, use_MSE=True)
            ...
            self.assertTensorsEqual(self_cpu2, self_mlu2.cpu().float(), 0.003, use_MSE=True)
