...
class TestOps(TestCase):
    ...
    def test_mean_exception(self):
        ...
        ref_msg = ref_msg + "Input dtype must be either a floating point or complex dtype. Got: Int"
    ...
    def test_mean_bfloat16(self):
        left = torch.testing.make_tensor((1, 1, 1024), dtype=torch.bfloat16, device='cpu')
