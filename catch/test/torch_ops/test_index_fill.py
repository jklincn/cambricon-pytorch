...
class TestIndexFillOp(TestCase):
    ...
    def test_index_fill_dtype(self):
        ...
        type_list = [torch.float, torch.int, torch.short, torch.int8,
                     torch.int32, torch.uint8, torch.long, torch.double, torch.bool]
        for t in type_list:
    ...
    def test_index_fill_exception(self):
        ...
        msg = "index_fill_ only supports a 0-dimensional value tensor," \
