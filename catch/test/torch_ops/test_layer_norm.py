...
class TestLayerNormOp(TestCase):
    ...
    def test_layer_norm(self):
        gen_params = [((256), (1, 199, 256)), ((1024), (37, 104, 1024)),
    ...
    def test_layer_norm_not_dense(self):
        gen_params = [((256), (1, 199, 256*2)), ((1024), (37, 104, 1024*2)),
                      ((1024), (32, 1, 1024*2)), ((2, 1024), (32, 2, 1024*2)),
                      ((1024), (32, 1, 1, 1024*2))]
    ...
    def test_layer_norm_channel_last(self):
        gen_params = [((256), (20, 1, 199, 256)), ((1024), (37, 5, 104, 1024)),
                      ((2, 1024), (32 ,32, 2, 1024)),
                      ((1024), (32, 1, 1, 1024))]
    ...
    def test_layer_norm_large(self):
        gen_params = [((13725), (48, 4096, 13725)), ((2), (1, 4096*48*13725, 2))]
