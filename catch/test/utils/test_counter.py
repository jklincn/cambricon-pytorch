...
class TestCatchCounter(TestCase):
    ...
    def test_gencase_warnings(self):
        warining_msg_list = ['CATCH_COUNTER_START and CATCH_COUNTER_END should be integers',
                             'CATCH_COUNTER_START and CATCH_COUNTER_END should'
        ...
        for warning_msg, warning_value in zip(warining_msg_list,\
                warning_value_list):
            if warning_value == 'L0':
