...
def _check_gencase():
    ...
    if start_count is not None and end_count is not None and gencase_level is not None:
        ...
        if gencase_level not in gencase_level_list:
            warnings.warn(f"CATCH_COUNTER enable failed, CATCH_COUNTER_LEVEL only support "
        ...
        try:
            ...
            warnings.warn("CATCH_COUNTER_START and CATCH_COUNTER_END should be integers")
            return

        if start_count < 0 or end_count < 0:
            warnings.warn("CATCH_COUNTER_START and CATCH_COUNTER_END should all be greater than 0")
            return
        ...
        if end_count > start_count:
            ...
            warnings.warn("CATCH_COUNTER_END should be greater than CATCH_COUNTER_START")
            return
    elif start_count is not None or end_count is not None or gencase_level is not None:
        warnings.warn("CATCH_COUNTER_START, CATCH_COUNTER_END, CATCH_COUNTER_LEVEL should be"
