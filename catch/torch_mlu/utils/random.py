...
import torch_mlu
from torch_mlu.core import current_device, device_count
from torch_mlu.core.lazy_init import _lazy_call, _lazy_init
...
def set_rng_state(new_state: Tensor, device: Union[int, str, torch.device] = 'mlu') -> None:
...
rng_interface = [get_rng_state, get_rng_state_all, set_rng_state, set_rng_state_all,
                 manual_seed, manual_seed_all, seed, seed_all, initial_seed]

for r in rng_interface:
    torch.mlu.__setattr__(r.__name__, r)
torch.__setattr__("Generator", torch_mlu._MLUC.Generator)
