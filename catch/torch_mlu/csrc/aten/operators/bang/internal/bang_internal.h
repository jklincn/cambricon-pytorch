...
void bang_fused_l2_norm_clean_internal(float* output_ptr, float* output_per_tensor_ptr,
                                       float* output_buffer_ptr,
                                       float* output_buffer_per_tensor_ptr,
                                       bool per_tensor, int tensor_num,
...
void bang_fused_sgd_internal(AddressList g,
                             AddressList i,
                             AddressList m,
                             AddressList o,
                             SizeList s,
