...
lstm_cell_forward_internal(const at::Tensor& input_gates, const at::Tensor& hidden_gates,
                           const at::Tensor& input_bias, const at::Tensor& hidden_bias,
                           const at::Tensor& cx, const at::Tensor& hy,
                           const at::Tensor& cy, at::Tensor& workspace);

std::tuple<at::Tensor, at::Tensor>
lstm_cell_backward_internal(const at::Tensor& grad_hy, const at::Tensor& grad_cy,
                            const at::Tensor& cx, const at::Tensor& cy,
                            const at::Tensor& workspace,
                            const at::Tensor& grad_gates, const at::Tensor& grad_cx);
...
std::vector<Tensor> cnnl_rnn_backward_weight_internal(
    ...
    const Tensor& output_r, int64_t fn_mode, int64_t fn_hidden_size,
    int64_t fn_num_layers, double fn_dropout, bool fn_train, bool fn_bidirectional,
    const int* batch_sizes_int_ptr, const at::Tensor& dev_batch_sizes,
    const Tensor& fn_dropout_state, const Tensor& fn_reserve);

std::tuple<Tensor, Tensor, Tensor> cnnl_rnn_backward_input_internal(
    const Tensor& input_r, const Tensor& weight_buf, int64_t weight_stride0,
    const Tensor& hx, const Tensor& cx, const Tensor& output_r,
    const Tensor& grad_output_r, const Tensor& grad_hy, const Tensor& grad_cy,
    int64_t fn_mode, int64_t fn_hidden_size, int64_t fn_num_layers,
    double fn_dropout, bool fn_train, bool fn_bidirectional,
    const int* batch_sizes_int_ptr, const at::Tensor& dev_batch_sizes,
    const Tensor& fn_dropout_state, const Tensor& fn_reserve,
    std::array<bool, 3> output_mask);

void cnnl_native_batch_norm_internal(
    at::Tensor& output, const at::Tensor& input, const at::Tensor& scale_t,
    const at::Tensor& bias_t, const at::Tensor& moving_mean, const at::Tensor& moving_var,
    Tensor& saved_mean, Tensor& saved_invstd, bool training, double momentum, double eps);
...
std::tuple<at::Tensor, at::Tensor>
cnnl_batch_norm_stats_internal(
    const at::Tensor& input, float epsilon);

std::tuple<at::Tensor, at::Tensor>
cnnl_batch_norm_gather_stats_with_counts_internal(
    const at::Tensor& mean_all, const at::Tensor& invstd_all, const at::Tensor& count_all,
    const at::Tensor& running_mean, const at::Tensor& running_var, float momentum, float epsilon);
...
cnnl_batch_norm_backward_reduce_internal(
    ...
    const at::Tensor& invstd, const at::Tensor& weight, const bool input_g,
    const bool weight_g, const bool bias_g);
...
at::Tensor& cnnl_copy_without_contiguous_internal(
    at::Tensor& output,
    const at::Tensor& input);
...
at::Tensor& cnnl_neg_internal(at::Tensor& output,
                              const at::Tensor& input);

at::Tensor& cnnl_unfold_internal(at::Tensor& output,
                                 const at::Tensor& input,
                                 int64_t dimension,
                                 int64_t size,
                                 int64_t step);

at::Tensor& cnnl_points_in_boxes_mlu_internal(at::Tensor& point_indices,
...
at::Tensor cnnl_multi_dims_slice_internal(const at::Tensor& input,
...
at::Tensor& cnnl_angle_internal(at::Tensor& output,
                                const at::Tensor& input);

at::Tensor& cnnl_abs_internal(at::Tensor& output,
                              const at::Tensor& input);
...
void cnnl_clamp_internal(at::Tensor& output,
                         const at::Tensor& self,
                         at::optional<at::Scalar> min,
                         at::optional<at::Scalar> max);

void cnnl_softplus_internal(at::Tensor& output,
                            const at::Tensor& input,
                            at::Scalar beta,
                            at::Scalar threshold);

void cnnl_softplus_backward_internal(const at::Tensor& self,
                                     const at::Tensor& grad_output,
                                     at::Scalar beta,
                                     at::Scalar threshold,
                                     at::Tensor& result);

void cnnl_activation_internal(at::Tensor& output,
                              const at::Tensor& input,
...
void cnnl_activation_backward_internal(at::Tensor& output,
                                       const at::Tensor& self,
...
void cnnl_maximum_internal(at::Tensor& output,
                           const at::Tensor& input,
                           const at::Tensor& other);

void cnnl_minimum_internal(at::Tensor& output,
                           const at::Tensor& input,
                           const at::Tensor& other);

void cnnl_hardtanh_backward_internal(at::Tensor& output,
                                     const at::Tensor& self,
                                     const at::Tensor& grad,
                                     at::Scalar min_val, at::Scalar max_val);

void cnnl_threshold_internal(at::Tensor& output,
                             const at::Tensor& input,
                             at::Scalar threshold,
                             at::Scalar value);

void cnnl_threshold_backward_internal(at::Tensor& result,
                                      const at::Tensor& grad_output,
                                      const at::Tensor& input,
                                      at::Scalar threshold);
...
void cnnl_kthvalue_internal(at::Tensor& values,
                            at::Tensor& indices,
                            const at::Tensor& self,
                            int64_t k,
                            int64_t dim);
...
at::Tensor& cnnl_exp_internal(at::Tensor& output,
                              const at::Tensor& input);

at::Tensor& cnnl_expm1_internal(at::Tensor& output,
                                const at::Tensor& input);

void cnnl_softmax_out_internal(const at::Tensor& input, int64_t dim,
                               at::Tensor & output, cnnlSoftmaxAlgorithm_t algo);

void cnnl_softmax_backward_out_internal(const at::Tensor& grad_output,
...
void cnnl_index_add_internal(const at::Tensor& output, const at::Tensor& input, int64_t dim,
                             const at::Tensor& index, const at::Tensor& source);

at::Tensor& cnnl_pow_internal(at::Tensor& output, const at::Tensor& input,
                              const at::Tensor& exponent);

at::Tensor cnnl_pool2d_internal(at::Tensor& output,
                                const at::Tensor& self,
...
at::Tensor cnnl_pool2d_backward_internal(const at::Tensor& gradInput,
...
at::Tensor cnnl_pool3d_internal(const at::Tensor& output,
                                const at::Tensor& self,
...
at::Tensor cnnl_pool3d_backward_internal(const at::Tensor& gradInput,
                                         const at::Tensor& gradOutput,
                                         const at::Tensor& self,
                                         const at::Tensor& indices,
                                         int kT, int kH, int kW,
...
void cnnl_adaptive_avg_pool_backward_internal(at::Tensor& grad_input,
                                              const at::Tensor& grad_output,
                                              const at::Tensor& input);
...
at::Tensor cnnl_where_internal(at::Tensor& output,
...
at::Tensor& cnnl_arange_internal(at::Tensor& out, const void* start_ptr,
                                 const void* step_ptr);

void cnnl_embedding_internal(const at::Tensor& weight,
                                   const at::Tensor& indices,
                                   at::Tensor& output,
                                   int64_t padding_idx,
...
at::Tensor cnnl_nms_internal(const at::Tensor& dets,
                             ...
                             cnnlNmsOutputMode_t mode);

void cnnl_embedding_dense_backward_internal(const at::Tensor& grad,
                                            const at::Tensor& indices,
                                            int64_t num_weights,
                                            int64_t padding_idx,
                                            bool scale_grad_by_freq,
...
void cnnl_embedding_bag_internal(const at::Tensor & weight,
                                 const at::Tensor & indices,
...
void cnnl_embedding_bag_dense_backward_internal(const at::Tensor & grad,
                                                const at::Tensor & indices,
                                                const at::Tensor & offsets,
...
at::Tensor& cnnl_masked_scatter_internal(at::Tensor& output,
                                         const at::Tensor& input,
                                         const at::Tensor& mask,
                                         const at::Tensor& source);

at::Tensor& cnnl_grid_sampler_internal(at::Tensor& output,
                                       const at::Tensor& input,
...
void cnnl_native_layer_norm_backward_internal(
    const at::Tensor& diff_z, const at::Tensor& x, int64_t axis,
    const at::Tensor& mean, const at::Tensor& rstd,
    const at::Tensor& weight, at::Tensor& diff_x,
    at::Tensor& diff_weight, at::Tensor& diff_bias);

void cnnl_ceil_internal(at::Tensor& output,
                        const at::Tensor& input);

at::Tensor& cnnl_boxes_iou_bev_internal(const at::Tensor& boxes_a,
                                        const at::Tensor& boxes_b,
                                        at::Tensor& ans_iou);

at::Tensor& cnnl_boxes_overlap_bev_out_internal(at::Tensor& output,
                                                const at::Tensor& self,
                                                const at::Tensor& other);
...
std::tuple<at::Tensor, at::Tensor, at::Tensor>
cnnl_group_norm_internal(at::Tensor& output, const at::Tensor& input,
                         const at::Tensor& weight, const at::Tensor& bias,
                         at::Tensor& mean, at::Tensor& rstd,
                         double eps, int64_t num_groups);

std::tuple<at::Tensor, at::Tensor, at::Tensor>
cnnl_group_norm_backward_internal(const at::Tensor& x_contiguous,
                                  const at::Tensor& dY,
...
at::Tensor cnnl_gather_internal(at::Tensor& output, const at::Tensor& self,
                                int64_t dim, const at::Tensor& index);

at::Tensor& cnnl_uniform_internal(at::Tensor& self,
                                  c10::optional<at::Generator> gen,
                                  float min,
                                  float max);
...
at::Tensor& cnnl_convolution_forward_internal(at::Tensor& output, const at::Tensor & input,
           ...
           const int64_t* stride, const int64_t* dilation, int64_t groups, bool benchmark,
...
at::Tensor& cnnl_bias_backward_internal(at::Tensor& output, const at::Tensor& input,
                                        int64_t dim);

at::Tensor& cnnl_random_internal(at::Tensor& output,
                                 int64_t from, int64_t to,
                                 c10::optional<at::Generator> gen);

void fused_dropout_internal(at::Tensor& output, at::Tensor& mask, const at::Tensor& self, double p,
                            c10::optional<at::Generator> gen);

at::Tensor& cnnl_nan_to_num_internal(at::Tensor& output,
                                     const at::Tensor& input,
...
void cnnl_index_fill_internal(at::Tensor& output,
                              const at::Tensor& self,
                              int64_t dim,
                              const at::Tensor& index,
                              at::Scalar value);

void cnnl_fmod_internal(at::Tensor& result,
                        const at::Tensor& self,
                        const at::Tensor& other);
...
at::Tensor cnnl_put_internal(at::Tensor& output_,
...
void cnnl_bce_internal(at::Tensor& loss,
                       const at::Tensor& self,
                       const at::Tensor& target,
                       const at::Tensor& weight,
                       int64_t reduction);

void cnnl_bce_bp_internal(at::Tensor& grad_input,
                          const at::Tensor& grad_output,
                          const at::Tensor& self,
                          const at::Tensor& target,
                          const at::Tensor& weight,
...
void cnnl_nll_loss_forward_internal(at::Tensor& output,
...
void cnnl_nll_loss_backward_internal(at::Tensor& grad_input,
                                           const at::Tensor &grad_output,
                                           const at::Tensor &self,
                                           const at::Tensor &target,
                                           const at::Tensor &weight,
...
std::tuple<Tensor&, Tensor&> cnnl_slogdet_internal(const at::Tensor& input, at::Tensor& sign,
                                  at::Tensor& output);

at::Tensor& cnnl_sign_internal(at::Tensor& output,
                              const at::Tensor& input);

void cnnl_index_copy_internal(at::Tensor& output,
                              const at::Tensor& input,
                              int64_t dim,
                              const at::Tensor& index,
                              const at::Tensor& source);
...
at::Tensor& cnnl_addcdiv_internal(at::Tensor& output,
                                  const at::Tensor& self,
...
void cnnl_histc_internal(const at::Tensor self,
                         int64_t bins,
                         float minvalue,
                         float maxvalue,
                         const at::Tensor output);
...
at::Tensor cnnl_dcn_forward_internal(
         ...
         const at::Tensor& mask, const at::Tensor& weight,
         const at::Tensor& bias, const std::vector<int64_t>& output_sizes,
         int* padding, int* stride, int* dilation,
         int64_t deformable_group, int64_t conv_group,
         int64_t im2col_step, int bitwidth, bool use_mask);
...
cnnl_dcn_backward_internal(
    ...
    int* padding, int* stride, int* dilation,
    int64_t deformable_group, int64_t conv_group,
    int64_t im2col_step, std::array<bool, 2> grad_input_mask,
    bool use_mask, int bitwidth);
...
void cnnl_var_internal(const at::Tensor& self,
                       at::Tensor& output,
                       at::IntArrayRef dim,
                       bool unbiased,
                       bool keepdim);

void cnnl_std_internal(const at::Tensor& self,
                       at::Tensor& output,
                       at::IntArrayRef dim,
                       bool unbiased,
                       bool keepdim);

void cnnl_remainder_internal(at::Tensor & output,
                             const at::Tensor& self,
                             const at::Tensor& other);

const at::Tensor& cnnl_fft_internal(at::Tensor& out, const at::Tensor& self,
                                    c10::IntArrayRef out_sizes,
                                    c10::IntArrayRef dim, bool forward,
...
void cnnl_cumsum_internal(at::Tensor& output, const at::Tensor& input, int64_t dim);

void cnnl_cumprod_internal(at::Tensor& output, const at::Tensor& input, int64_t dim);
...
at::Tensor cnnl_take_internal(const at::Tensor& input_,
                               const at::Tensor& index_,
                               at::Tensor& output);
...
at::Tensor& cnnl_masked_softmax_internal(at::Tensor& output, const at::Tensor& input,
    const at::Tensor& mask, const int axis);

at::Tensor& cnnl_masked_softmax_dropout_backward_internal(at::Tensor& diff_x,
    const at::Tensor& softmax_out, const at::Tensor& diff_y,
    const at::Tensor& dropout_dropout_mask, const int axis, const float p);

at::Tensor& cnnl_conj_internal(at::Tensor& output, const at::Tensor& input);

at::Tensor cnnl_cdist_forward_internal(at::Tensor& result, const at::Tensor& x1,
    const at::Tensor& x2, const double p);

at::Tensor cnnl_cdist_backward_internal(at::Tensor& grad_x1, const at::Tensor& x1,
                                        const at::Tensor& x2, const at::Tensor& cdist,
                                        const double p, const at::Tensor& grad);

at::Tensor cnnl_repeat_interleave_internal(at::Tensor &output,
                                           const at::Tensor &index,
                                           const at::Tensor &repeats);

at::Tensor cnnl_linspace_internal(at::Tensor& output,
                                  at::Scalar start,
                                  at::Scalar end,
                                  int64_t steps);

at::Tensor& cnnl_det_internal(at::Tensor& output,
                              const at::Tensor& input,
                              cnnlDetMode_t mode);
...
at::Tensor& im2col_out_internal(at::Tensor& output,
                                const at::Tensor& input,
...
at::Tensor& col2im_out_internal(at::Tensor& output,
                                const at::Tensor& input,
                                const std::vector<int64_t>& kernel_size,
                                const std::vector<int64_t>& dilation,
                                const std::vector<int64_t>& padding,
...
at::Tensor cnnl_max_unpool2d_internal(at::Tensor& output, const at::Tensor& self,
                                      const at::Tensor& indices, at::IntArrayRef kernel_size,
                                      at::IntArrayRef stride, at::IntArrayRef padding);

at::Tensor cnnl_max_unpool2d_backward_internal(const at::Tensor & grad_output,
                                               const at::Tensor & self,
                                               const at::Tensor & indices,
                                               at::IntArrayRef kernel_size,
                                               at::IntArrayRef stride,
...
void cnnl_svd_internal(std::tuple<at::Tensor&, at::Tensor&, at::Tensor&>& outputs,
                       const at::Tensor& self,
                       bool some,
                       bool compute_uv,
...
void cnnl_inverse_internal(const at::Tensor& output, const at::Tensor& input,
                           const at::Tensor& infos);

void cnnl_bincount_internal(const at::Tensor& output,
                            const at::Tensor& self,
                            const at::Tensor& weight,
