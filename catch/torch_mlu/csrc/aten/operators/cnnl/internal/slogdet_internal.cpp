...
std::tuple<Tensor&, Tensor&> cnnl_slogdet_internal(const at::Tensor& input,
                                                   at::Tensor& sign,
                                                   at::Tensor& output) {
  ...
  TORCH_CNNL_CHECK(cnnlSlogDet(handle, descInput.desc(), input_ptr,
                           descOutput.desc(), output_ptr, descSign.desc(),
                           sign_impl_ptr));
