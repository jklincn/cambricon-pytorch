...
at::Tensor& cnnl_addcdiv_internal(at::Tensor& output, const at::Tensor& self,
  ...
  TORCH_CNNL_CHECK(cnnlGetAddcdivWorkspaceSize(handle, desc_self_, desc_tensor1_,
  ...
  // compute ops
  TORCH_CNNL_CHECK(cnnlAddcdiv(handle, desc_self.desc(), self_ptr, &f_alpha,
