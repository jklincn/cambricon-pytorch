...
REGISTER_MLU_DISPATCH(log_stub, &log_kernel_mlu);
REGISTER_MLU_DISPATCH(log10_stub, &log10_kernel_mlu);
REGISTER_MLU_DISPATCH(log1p_stub, &log1p_kernel_mlu);
REGISTER_MLU_DISPATCH(log2_stub, &log2_kernel_mlu);
