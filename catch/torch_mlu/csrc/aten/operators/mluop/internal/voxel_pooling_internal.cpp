...
void mluop_voxel_pooling_internal(const at::Tensor& geom_xyz,
  ...
  TORCH_MLUOP_CHECK(mluOpVoxelPoolingForward(handle, batch_size, num_points, num_channels,
                                             num_voxel_x, num_voxel_y, num_voxel_z,
                                             geom_xyz_desc.desc(), geom_xyz_ptr,
                                             input_features_desc.desc(), input_features_ptr,
                                             output_features_desc.desc(), output_features_ptr,
                                             pos_memo_desc.desc(), pos_memo_ptr));
}
