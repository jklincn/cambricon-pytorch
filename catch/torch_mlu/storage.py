...
class _MLUStorageBase(object):
    ...
    def _share_mlu_(self, *args, **kwargs): ...  # noqa: E704
    def is_shared(self) -> bool: ...  # noqa: E704
    @classmethod
    def _new_shared_mlu(cls, *args, **kwargs) -> T: ...  # noqa: E704
    ...
    def __sizeof__(self):
        return super(_MLUStorageBase, self).__sizeof__() + self.size()
    ...
    def pin_memory(self):
        ...
        if self.is_mlu:
            ...
            allocator = _MLUC._mluHostAllocator()
