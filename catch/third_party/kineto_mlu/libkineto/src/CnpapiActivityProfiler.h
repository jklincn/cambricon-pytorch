...
class CnpapiActivityProfiler {
 ...
 private:
  ...
  std::set<const cnpapiActivity*> noLinkedMluRecords_;
...
#ifdef HAS_CNPAPI
  // Process generic CNPAPI activity
  void handleCnpapiActivity(const cnpapiActivity* record, ActivityLogger* logger);
  ...
  void handleRuntimeActivity(
      const cnpapiActivityAPI* activity, ActivityLogger* logger);
  void handleOverheadActivity(
      const cnpapiActivityOverhead* activity, ActivityLogger* logger);
